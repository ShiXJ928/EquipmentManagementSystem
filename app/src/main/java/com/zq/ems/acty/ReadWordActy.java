...
import com.zq.ems.view.SuperFileView;
...
public class ReadWordActy extends BaseActy {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acty_read_word);
        init();
    }
    ...
    public static void show(Context context, String url) {
        Intent intent = new Intent(context, ReadWordActy.class);
    ...
    private void downLoadFromNet(final String url, final SuperFileView mSuperFileView2) {
        ...
        Utility.loadPdfFile(url, new Callback<ResponseBody>() {
            @Override
    ...
    private String getFileName(String url) {
        String fileName = Utility.hashKey(url) + "." + getFileType(url);
        return fileName;
    }
